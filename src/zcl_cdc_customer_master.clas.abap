...
CLASS zcl_cdc_customer_master IMPLEMENTATION.
  ...
  METHOD if_sadl_exit_calc_element_read~calculate.
    ...
    TRY.
        "1. send request using proxy app
        DATA: lv_url TYPE string VALUE 'https://d0ed0cadtrial-d0ed0cadtrial-dev-proxyapp.cfapps.eu10.hana.ondemand.com/'.
...
* Example calling API Hub sandbox straightaway without Service Consumption Model
*
